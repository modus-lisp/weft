...
(defparameter *supported-properties*
  (let ((h (make-hash-table :test 'equal)))
    (dolist (p '("accent-color" "align-content" "align-items" "align-self" "all"
                 ...
                 "border-image-width" "border-inline" "border-inline-end"
                 ...
                 "cursor" "direction" "display" "fill" "stroke" "flex" "flex-basis" "flex-direction"
                 "filter"
                 ...
                 "object-fit" "object-position" "opacity" "perspective" "backface-visibility"
