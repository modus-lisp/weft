...
(defun computed-prop (cs dashed)
  ...
  (macrolet ((s (accessor) `(,accessor cs)))
    (cond
      ((string= dashed "display") (s cstyle-display))
      ((string= dashed "white-space") (s cstyle-white-space))
      ((string= dashed "position") (s cstyle-position))
      ((string= dashed "float") (s cstyle-float))
      ((string= dashed "clear") (s cstyle-clear))
      ((string= dashed "overflow") (s cstyle-overflow))
      ((string= dashed "text-align") (s cstyle-text-align))
      ((string= dashed "box-sizing") (s cstyle-box-sizing))
      ((string= dashed "font-style") (s cstyle-font-style))
      ((string= dashed "z-index") (let ((z (s cstyle-z-index)))
                                    (if (integerp z) (princ-to-string z) (px z))))
      ((string= dashed "font-weight") (princ-to-string (s cstyle-font-weight)))
      ((string= dashed "font-size") (px (s cstyle-font-size)))
      ((string= dashed "line-height") (px (s cstyle-line-height)))
      ((string= dashed "color") (rgb-str (s cstyle-color)))
      ((string= dashed "width") (px (s cstyle-width)))
      ((string= dashed "height") (px (s cstyle-height)))
      ((string= dashed "min-width") (px (s cstyle-min-width)))
      ((string= dashed "max-width") (px (s cstyle-max-width)))
      ((string= dashed "min-height") (px (s cstyle-min-height)))
      ((string= dashed "max-height") (px (s cstyle-max-height)))
      ((string= dashed "margin-top") (px (s cstyle-margin-top)))
      ((string= dashed "margin-right") (px (s cstyle-margin-right)))
      ((string= dashed "margin-bottom") (px (s cstyle-margin-bottom)))
      ((string= dashed "margin-left") (px (s cstyle-margin-left)))
      ((string= dashed "padding-top") (px (s cstyle-padding-top)))
      ((string= dashed "padding-right") (px (s cstyle-padding-right)))
      ((string= dashed "padding-bottom") (px (s cstyle-padding-bottom)))
      ((string= dashed "padding-left") (px (s cstyle-padding-left)))
      ((string= dashed "top") (px (s cstyle-top)))
      ((string= dashed "left") (px (s cstyle-left)))
      ((string= dashed "right") (px (s cstyle-right)))
      ((string= dashed "bottom") (px (s cstyle-bottom)))
      (t ""))))
