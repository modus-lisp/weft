...
;;;; package is the seam: it backs `document` and the elements it hands out with
;;;; shuttle host objects, so a <script> can read and mutate the live weft DOM
;;;; and have the change reflected on relayout.
(defpackage #:weft.script
  ...
  (:export #:make-context #:context-realm #:context-document #:context-dirty
           #:element-object #:run-inline-scripts
